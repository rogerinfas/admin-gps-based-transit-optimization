    ...
    <PageShell navbarVariant="dark">
        <section className="grid items-start gap-8 lg:grid-cols-[1fr_430px]">
          <div className="max-w-lg">
            <p className="text-sm text-muted-foreground">Lima, PE</p>
            ...
            <p className="mt-3 text-sm text-muted-foreground">Consulta estado de buses y ETA de llegada por corredor.</p>
          </div>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          <article className="rounded-2xl bg-surface-strong p-5 ring-1 ring-foreground/10">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Operacion continua en 6 corredores urbanos.</p>
          </article>
          <article className="rounded-2xl bg-surface-strong p-5 ring-1 ring-foreground/10">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Cumplimiento de frecuencia por encima del objetivo.</p>
          </article>
          <article className="rounded-2xl bg-surface-strong p-5 ring-1 ring-foreground/10">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Seguimiento GPS y alertas en tiempo casi real.</p>
          </article>
        </section>
    </PageShell>
  );
